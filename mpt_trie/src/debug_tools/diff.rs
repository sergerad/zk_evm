...
mod tests {
    ...
    fn multi_node_multi_diff_works_accounts() -> Result<(), Box<dyn std::error::Error>> {
        ...
        let mut data = vec![
            (
                ...
                TestAccountRlp {
                    nonce: U256::from(1),
                    balance: U256::from(2),
                    storage_root: B256::from(U256::from(1312378)),
                    code_hash: B256::from(U256::from(943221)),
                },
            ),
            (
                ...
                TestAccountRlp {
                    nonce: U256::from(2),
                    balance: U256::from(3),
                    storage_root: B256::from(U256::from(1123178)),
                    code_hash: B256::from(U256::from(8133221)),
                },
            ),
            (
                ...
                TestAccountRlp {
                    ...
                    storage_root: B256::from(U256::from(12345678)),
                    code_hash: B256::from(U256::from(94321)),
                },
            ),
            (
                ...
                TestAccountRlp {
                    ...
                    storage_root: B256::from(U256::from(123456781)),
                    code_hash: B256::from(U256::from(943214141)),
                },
            ),
        ];
        ...
        data[3].1.storage_root = B256::from(U256::from(4445556));
